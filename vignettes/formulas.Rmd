...
color gradient is used. netplot detects that the attribute is continuous and
draws a **color bar** (rather than a set of discrete keys) as the legend:

```{r color-numeric, fig.cap="Vertices colored by in-degree (a numeric attribute) using a continuous gradient, with a color-bar legend."}
