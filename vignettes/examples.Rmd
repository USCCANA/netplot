...
nplot(x, layout = l, edge.line.type = "b", edge.line.breaks=10)
nplot(x, layout = l, edge.line.type = "p", edge.line.breaks=10)
nplot(x, layout = l, edge.line.type = "p", edge.line.breaks=10, edge.line.pch = 3)
par(oldpar)
```
